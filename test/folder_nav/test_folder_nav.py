...
class TestFolderNav:
    ...
    def test_ui_initialization(self, folder_nav):
        ...
        assert folder_nav.folder_nav_filters.parent() == folder_nav
    ...
    def test_set_root_folder(self, folder_nav):
        ...
        assert folder_nav.folder_nav_filters.root_folders == test_paths
    ...
    def test_apply_filters_call(self, folder_nav, qtbot):
        ...
        with patch.object(
            folder_nav.folder_nav_filters, "apply_filters", return_value=mock_items
        ) as mock_apply:
    ...
    def test_signal_forwarding(self, folder_nav, qtbot):
        ...
        with qtbot.waitSignal(folder_nav.sig_root_folder) as blocker:
            folder_nav.folder_nav_filters.sig_root_folder.emit("/emitted/path")
