...
class TestAppController:
    ...
    def test_set_current_file(self, controller, qtbot):
        with qtbot.waitSignal(controller.signals.file_changed) as blocker:
    ...
    def test_set_current_tab(self, controller, qtbot):
        with qtbot.waitSignal(controller.signals.tab_changed) as blocker:
    ...
    def test_selection_changed_emitted(self, controller, qtbot):
        with qtbot.waitSignal(controller.signals.image_changed):
